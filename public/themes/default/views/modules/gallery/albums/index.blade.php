        ...
        <div class="col-md-3">
            <div class="panel panel-primary">
                ...
                <div class="panel-footer text-center">
                    <div class="btn-group">
                        <a href="{{route('get.albums.view', array($album->id))}}" class="btn btn-default btn-sm tip" title="View Photos"><i class="icon-picture"></i></a>
                        <a href="{{route('get.albums.photos.add', array($album->id))}}" class="btn btn-default btn-sm tip" title="Add Photos"><i class="icon-plus"></i></a>
                        <a href="{{route('get.albums.edit', array($album->id))}}" class="btn btn-default btn-sm tip" title="Edit Album"><i class="icon-pencil"></i></a>
                        <a href="{{route('get.albums.delete', array($album->id))}}" class="btn btn-default btn-sm confirm tip" title="Delete Album"><i class="icon-trash"></i></a></div>
